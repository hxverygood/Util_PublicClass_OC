...
//static  = UIColor colorWithRed:107/255.0 green:65/255.0 blue:19/255.0 alpha:1.0];
...
- (UIColor *)defaultTitleColor {
    if (!_defaultTitleColor) {
        _defaultTitleColor = [UIColor colorWithRed:107/255.0 green:65/255.0 blue:19/255.0 alpha:1.0];
    }
