...
+ (UIColor *)colorWithTrafficStatus:(NSString *)status
{
    ...
    if (colorMapping == nil)
    {
        colorMapping = @{@"未知":[UIColor colorWithRed:70/255.0 green:194/255.0 blue:132/255.0 alpha:1.0],
                         @"畅通":[UIColor colorWithRed:70/255.0 green:194/255.0 blue:132/255.0 alpha:1.0],
                         @"缓行":[UIColor colorWithRed:245/255.0 green:196/255.0 blue:79/255.0 alpha:1.0],
                         @"拥堵":[UIColor colorWithRed:235/255.0 green:100/255.0 blue:95/255.0 alpha:1.0]};
    }
...
- (id)init
{
    ...
    if (self)
    {
        ...
        // 墨绿
        UIColor *traffic1 = [UIColor colorWithRed:70/255.0 green:194/255.0 blue:132/255.0 alpha:1.0];
        // 黄色
        UIColor *traffic2 = [UIColor colorWithRed:245/255.0 green:196/255.0 blue:79/255.0 alpha:1.0];
        // 橙色
        UIColor *traffic3 = [UIColor colorWithRed:252/255.0 green:147/255.0 blue:87/255.0 alpha:1.0];
        // 红色
        UIColor *traffic4 = [UIColor colorWithRed:235/255.0 green:100/255.0 blue:95/255.0 alpha:1.0];

        self.routeColor = traffic1;
        self.walkingColor = [UIColor cyanColor];
        self.railwayColor = [UIColor greenColor];

        
        self.trafficColors = @[traffic1, traffic2, traffic3, traffic4];
    }
